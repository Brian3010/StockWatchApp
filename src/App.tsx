...
const menuItems: menuItem[] = [
  ...
  {
    name: 'Closing Checklists',
    to: '/boh-closing-tasks-menu',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
      ...
      <div className="grid gap-2 pt-2 mobileXS:grid-cols-1 mobileS:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-2 ">
        ...
        {menuItems.map((item, index) => (
          <Link
            ...
            key={index}
          >
            <div className="flex flex-col flex-wrap items-center gap-3 p-2">
              <div className="rounded-full border border-gray-400 p-3">{item.icon}</div>
